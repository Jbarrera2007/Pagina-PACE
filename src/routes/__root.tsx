...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PACE — Train Smarter. Run Faster." },
      {
        name: "description",
        content:
          "La plataforma inteligente que analiza automáticamente tus entrenamientos para ayudarte a correr más rápido.",
      },
      { name: "theme-color", content: "#0d0f12" },
      { property: "og:title", content: "PACE — Train Smarter. Run Faster." },
      {
        property: "og:description",
        content: "Análisis automático de entrenamiento con IA para corredores.",
      },
